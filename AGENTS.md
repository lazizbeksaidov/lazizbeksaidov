...
- Do not hand-edit files in `assets/hero/` or `assets/activity/`; they are generated.
...
- Only generated ASCII and public contribution SVG/data assets may be committed.
...
For visual changes, render and inspect desktop/mobile hero variants and both themed contribution variants.
