...
<p align="center">
  <picture>
    <source media="(max-width: 1100px) and (prefers-color-scheme: dark)" srcset="./assets/activity/contribution-console-b0a3b979-mobile-dark.svg">
    <source media="(max-width: 1100px)" srcset="./assets/activity/contribution-console-b0a3b979-mobile-light.svg">
    <source media="(prefers-color-scheme: dark)" srcset="./assets/activity/contribution-console-b0a3b979-dark.svg">
    <source media="(prefers-color-scheme: light)" srcset="./assets/activity/contribution-console-b0a3b979-light.svg">
    <img src="./assets/activity/contribution-console-b0a3b979-dark.svg" alt="Lazizbek Saidov public GitHub activity: 49 contributions across 12 active days" width="100%">
  </picture>
</p>
